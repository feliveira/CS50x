...
def dashboard():
    ...
    rows = rows.fetchall()
    info = {
        'balance': convert(10000, session['curr']),
        'bills': convert(10000, session['curr']),
        'food': convert(10000, session['curr']),
        'shopping': convert(10000, session['curr']),
        'savings': convert(10000, session['curr']),
        'other': convert(10000, session['curr'])
    }
